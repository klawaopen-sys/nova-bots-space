...
const PAGE_TRANSLATIONS = {
    uk: {
        ...
        "prod_voice_desc": "Зручний плаваючий віджет для будь-якого комп'ютера (Windows, macOS, Linux). Дозволяє надиктовувати текст голосом у будь-яке активне текстове поле на ПК. Підтримує підключення будь-яких ШІ-моделей розпізнавання мови. 🎁 Надається БЕЗКОШТОВНО за підписку на наші канали або як подарунок при замовленні будь-якого бота «Під ключ»!",
        ...
        "price_sub_desc": "Повний супровід вашого бота. Ми беремо на себе хостинг, щоденну перевірку працездатності, моніторинг логов та оновлення під зміни API Telegram.",
        "price_sub_price_val": "$25",
    ...
    ru: {
        ...
        "prod_voice_title": "Voice Widget (Desktop App)",
        "prod_voice_desc": "Удобный плавающий виджет для любого компьютера (Windows, macOS, Linux). Позволяет надиктовывать текст голосом в любое активное текстовое поле на ПК. Поддерживает подключение любых ИИ-моделей распознавания речи. 🎁 Предоставляется БЕСПЛАТНО за подписку на наши каналы или в подарок при заказе любого бота «Под ключ»!",
        ...
        "price_sub_desc": "Полное сопровождение вашего бота. Мы берем на себя хостинг, ежедневную проверку работоспособности, мониторинг логов и обновления под изменения API Telegram.",
        "price_sub_price_val": "$25",
    ...
    en: {
        ...
        "prod_voice_title": "Voice Widget (Desktop App)",
        "prod_voice_desc": "Convenient floating widget for any desktop system (Windows, macOS, Linux). Dictate text with your voice into any active text field on your computer. Supports integration with any speech-to-text models. 🎁 Available for FREE by subscribing to our channels or as a gift when ordering any 'Turnkey' bot!",
        ...
        "price_sub_desc": "Active cloud hosting, regular server diagnostics, code adaptations for Telegram API changes, and back-ups.",
        "price_sub_price_val": "$25",
        "price_once": "/ one-time",
        "price_monthly": "/ month",
